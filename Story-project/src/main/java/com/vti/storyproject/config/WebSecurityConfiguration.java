...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/api/not-authenticated", "/api/v1/auth/login-jwt", "/api/v1/auth/login-basic",
                        "/api/v1/account/create", "/api/v1/novels/search", "/api/v1/novels/get-all").permitAll()
        ...
        // khai báo lớp fillter sẽ được thực hiện trước khi xác thực trước khi authen và author
